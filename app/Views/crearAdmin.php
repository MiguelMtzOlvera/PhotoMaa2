		...
		<div class="form-group">
			<label for="exampleFormControlTextarea1">Inserte el nombre de la clasificacion</label>
			<textarea class="form-control" id="exampleFormControlTextarea1" rows="1" ></textarea>
		</div>
		<br>
		<button type="button" class="btn btn-warning" onclick="location.href='<?php echo base_url();?>/index.php/admin/crear'">Agregar</button>
		<button type="button" class="btn btn-info" onclick="location.href='<?php echo base_url();?>/index.php/admin/acceder'">Iniciar sesión</button>
